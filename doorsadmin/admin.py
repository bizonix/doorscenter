...
class BaseAdminManaged(BaseAdmin):
    ...
    MakeStateManagedNew.short_description = "Mark selected items as new"
...
class HostAdmin(BaseAdmin):
    list_display = ('type', 'company', 'hostName', 'costPerMonth', 'diskSpace', 'traffic', 'controlPanelType', 'GetIPAddressesCount', 'GetDomainsCount', 'GetDoorsCount', 'GetPagesCount', 'stateSimple', 'dateAdded')
    fieldsets = [
...
class IPAddressAdmin(BaseAdmin):
    list_display = ('address', 'host', 'GetDomainsCount', 'GetDoorsCount', 'GetPagesCount', 'stateSimple', 'dateAdded')
    fieldsets = [
...
class DoorwayAdmin(BaseAdminManaged):
    list_display = ('pk', 'net', 'niche', 'GetLanguage', 'template', 'keywordsSet', 'pagesCount', 'GetDomainAndUrl', 'spamLinksCount', 'GetSpamTasksCount', 'GetRunTime', 'stateManaged', 'agent', 'dateAdded')
    ...
    fieldsets = [
        ...
        ('Lists', {'fields': ['keywordsList', 'spamLinksList', 'netLinksList'], 'classes': ['collapse']}),
...
class NicheAdmin(BaseAdmin):
    list_display = ('description', 'language', 'GetDomainsCount', 'GetDoorsCount', 'GetPagesCount', 'GetKeywordsSetsCount', 'GetTemplatesCount', 'GetXrumerBasesRCount', 'GetSpamTasksCount', 'GetSnippetsSetsCount', 'active', 'stateSimple', 'dateAdded')
    fieldsets = [
...
class KeywordsSetAdmin(BaseAdmin):
    list_display = ('description', 'niche', 'localFolder', 'encoding', 'keywordsCount', 'GetDoorsCount', 'GetPagesCount', 'active', 'stateSimple', 'dateAdded')
    fieldsets = [
...
class TemplateAdmin(BaseAdmin):
    list_display = ('description', 'niche', 'type', 'localFolder', 'GetDoorsCount', 'GetPagesCount', 'active', 'stateSimple', 'dateAdded')
    fieldsets = [
...
class NetAdmin(BaseAdmin):
    list_display = ('description', 'GetDoorsCount', 'GetPagesCount', 'active', 'stateSimple', 'dateAdded')
    fieldsets = [
        (None, {'fields': ['description', 'active']}),
        ('Analytics', {'fields': [('analyticsId', 'piwikId', 'cyclikId')], 'classes': ['collapse']}),
        ('Remarks', {'fields': ['remarks'], 'classes': ['collapse']}),
        ('State information', {'fields': [('stateSimple', 'lastError'), ('dateAdded', 'dateChanged')], 'classes': ['collapse']}),
    ]
...
class DoorwayScheduleAdmin(BaseAdmin):
    list_display = ('pk', 'net', 'niche', 'template', 'keywordsSet', 'minPagesCount', 'maxPagesCount', 'minSpamLinksCount', 'maxSpamLinksCount', 'dateStart', 'dateEnd', 'doorsPerDay', 'GetDoorsCount', 'GetPagesCount', 'active', 'stateSimple', 'dateAdded')
    fieldsets = [
        (None, {'fields': [('net', 'niche'), ('template', 'keywordsSet'), ('minPagesCount', 'maxPagesCount', 'minSpamLinksCount', 'maxSpamLinksCount'), ('dateStart', 'dateEnd', 'doorsPerDay'), 'active']}),
...
class XrumerBaseRawAdmin(BaseAdminManaged):
    list_display = ('baseNumber', 'GetXrumerBasesRCount', 'active', 'GetRunTime', 'stateManaged', 'agent', 'dateAdded')
    fieldsets = [
...
class XrumerBaseRAdmin(BaseAdmin):
    list_display = ('baseNumber', 'niche', 'xrumerBaseRaw', 'GetSpamTasksCount', 'active', 'stateSimple', 'dateAdded')
    fieldsets = [
...
class XrumerProjectAdmin(BaseAdmin):
    list_display = ('xrumerBaseR', 'spamTask', 'stateSimple', 'dateAdded')
    fieldsets = [
...
class SnippetsSetAdmin(BaseAdminManaged):
    list_display = ('niche', 'localFile', 'keywordsCount', 'interval', 'dateLastParsed', 'phraseCount', 'active', 'GetRunTime', 'stateManaged', 'agent', 'dateAdded')
    fieldsets = [
