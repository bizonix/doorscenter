...
opener.addheaders.append(('Cookie', 'ids=392716%2C360667%2C412156%2C398503%2C378384%2C357007%2C376179%2C362302%2C360648%2C419673%2C357441%2C399019%2C363392%2C377660%2C403300%2C410614%2C376254%2C392812; id=22; hash=b5d0c95a0da621aadc4693bdf69ea483'))
...
domainsAvailable = [item for item in availability if availability[item]]
print('%d domains available.' % len(domainsAvailable))

'''Checking domains index'''
domainsChecked = {}
for domain in domainsAvailable:
    domainsChecked[domain] = google.GetIndex(domain)
    print domainsChecked[domain]

'''Showing the results'''
for domain in sorted(domainsChecked, key=domainsChecked.get, reverse=True):
    print domain, domainsChecked[domain]
