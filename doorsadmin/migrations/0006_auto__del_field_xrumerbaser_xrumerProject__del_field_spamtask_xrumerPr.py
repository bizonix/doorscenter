...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'XrumerBaseR.xrumerProject'
        db.delete_column('doorsadmin_xrumerbaser', 'xrumerProject_id')

        # Deleting field 'SpamTask.xrumerProject'
        db.delete_column('doorsadmin_spamtask', 'xrumerProject_id')

        # Adding field 'XrumerProject.spamTask'
        db.add_column('doorsadmin_xrumerproject', 'spamTask', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['doorsadmin.SpamTask'], unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'XrumerProject.xrumerBaseR'
        db.add_column('doorsadmin_xrumerproject', 'xrumerBaseR', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.XrumerBaseR'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'XrumerBaseR.xrumerProject'
        db.add_column('doorsadmin_xrumerbaser', 'xrumerProject', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.XrumerProject'], null=True, blank=True), keep_default=False)

        # Adding field 'SpamTask.xrumerProject'
        db.add_column('doorsadmin_spamtask', 'xrumerProject', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.XrumerProject'], null=True, blank=True), keep_default=False)

        # Deleting field 'XrumerProject.spamTask'
        db.delete_column('doorsadmin_xrumerproject', 'spamTask_id')

        # Deleting field 'XrumerProject.xrumerBaseR'
        db.delete_column('doorsadmin_xrumerproject', 'xrumerBaseR_id')
