...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SpamLink.url'
        db.delete_column('doorsadmin_spamlink', 'url')

        # Deleting field 'SpamLink.done'
        db.delete_column('doorsadmin_spamlink', 'done')

        # Adding field 'SpamLink.link'
        db.add_column('doorsadmin_spamlink', 'link', self.gf('django.db.models.fields.CharField')(default='', max_length=500), keep_default=False)

        # Adding field 'SpamLink.spamTask'
        db.add_column('doorsadmin_spamlink', 'spamTask', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.SpamTask'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SpamLink.url'
        db.add_column('doorsadmin_spamlink', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=500), keep_default=False)

        # Adding field 'SpamLink.done'
        db.add_column('doorsadmin_spamlink', 'done', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'SpamLink.link'
        db.delete_column('doorsadmin_spamlink', 'link')

        # Deleting field 'SpamLink.spamTask'
        db.delete_column('doorsadmin_spamlink', 'spamTask_id')
    ...
    models = {
        ...
        'doorsadmin.xrumerbaser': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'agent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doorsadmin.Agent']", 'null': 'True', 'blank': 'True'}),
            'baseNumber': ('django.db.models.fields.IntegerField', [], {'default': '4', 'unique': 'True'}),
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
