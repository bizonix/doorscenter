...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('doorsadmin_spamlink', 'doorsadmin_doorlink')
        db.rename_column('doorsadmin_doorway', 'spamLinksCount', 'doorLinksCount')


    def backwards(self, orm):
        db.rename_table('doorsadmin_doorlink', 'doorsadmin_spamlink')
        db.rename_column('doorsadmin_doorway', 'doorLinksCount', 'spamLinksCount')
