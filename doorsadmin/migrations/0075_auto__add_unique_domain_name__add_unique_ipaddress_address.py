...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('doorsadmin_domain', ['name'])

        # Adding unique constraint on 'IPAddress', fields ['address']
        db.create_unique('doorsadmin_ipaddress', ['address'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'IPAddress', fields ['address']
        db.delete_unique('doorsadmin_ipaddress', ['address'])

        # Removing unique constraint on 'Domain', fields ['name']
        db.delete_unique('doorsadmin_domain', ['name'])
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 5, 28)', 'null': 'True', 'blank': 'True'}),
