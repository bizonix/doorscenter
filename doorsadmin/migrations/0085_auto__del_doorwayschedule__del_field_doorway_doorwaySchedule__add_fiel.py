...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'DoorwaySchedule'
        db.delete_table('doorsadmin_doorwayschedule')

        # Deleting field 'Doorway.doorwaySchedule'
        db.delete_column('doorsadmin_doorway', 'doorwaySchedule_id')

        # Adding field 'Net.dateStart'
        db.add_column('doorsadmin_net', 'dateStart', self.gf('django.db.models.fields.DateField')(default=datetime.date.today, null=True, blank=True), keep_default=False)

        # Adding field 'Net.dateEnd'
        db.add_column('doorsadmin_net', 'dateEnd', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Net.doorsPerDay'
        db.add_column('doorsadmin_net', 'doorsPerDay', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)

        # Adding field 'Net.doorsToday'
        db.add_column('doorsadmin_net', 'doorsToday', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)

        # Adding field 'Net.lastRun'
        db.add_column('doorsadmin_net', 'lastRun', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'DoorwaySchedule'
        db.create_table('doorsadmin_doorwayschedule', (
            ('lastRun', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ...
            ('doorsToday', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ...
            ('dateStart', self.gf('django.db.models.fields.DateField')(default=datetime.date.today, null=True, blank=True)),
            ('doorsPerDay', self.gf('django.db.models.fields.IntegerField')(default=1, null=True)),
        ...
        db.send_create_signal('doorsadmin', ['DoorwaySchedule'])

        # Adding field 'Doorway.doorwaySchedule'
        db.add_column('doorsadmin_doorway', 'doorwaySchedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.DoorwaySchedule'], null=True, blank=True), keep_default=False)

        # Deleting field 'Net.dateStart'
        db.delete_column('doorsadmin_net', 'dateStart')

        # Deleting field 'Net.dateEnd'
        db.delete_column('doorsadmin_net', 'dateEnd')

        # Deleting field 'Net.doorsPerDay'
        db.delete_column('doorsadmin_net', 'doorsPerDay')

        # Deleting field 'Net.doorsToday'
        db.delete_column('doorsadmin_net', 'doorsToday')

        # Deleting field 'Net.lastRun'
        db.delete_column('doorsadmin_net', 'lastRun')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 7, 23)', 'null': 'True', 'blank': 'True'}),
