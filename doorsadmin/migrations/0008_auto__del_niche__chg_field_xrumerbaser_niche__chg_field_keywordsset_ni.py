...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'XrumerBaseR.niche'
        db.alter_column('doorsadmin_xrumerbaser', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Doorways.Niche'], null=True))

        # Changing field 'KeywordsSet.niche'
        db.alter_column('doorsadmin_keywordsset', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Doorways.Niche'], null=True))

        # Changing field 'Doorway.niche'
        db.alter_column('doorsadmin_doorway', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Doorways.Niche'], null=True))

        # Changing field 'SnippetsSet.niche'
        db.alter_column('doorsadmin_snippetsset', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Doorways.Niche'], null=True))

        # Changing field 'Template.niche'
        db.alter_column('doorsadmin_template', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Doorways.Niche'], null=True))

        # Changing field 'DoorwayTask.niche'
        db.alter_column('doorsadmin_doorwaytask', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Doorways.Niche'], null=True))

        # Changing field 'SpamTask.niche'
        db.alter_column('doorsadmin_spamtask', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Doorways.Niche'], null=True))

        # Changing field 'Domain.niche'
        db.alter_column('doorsadmin_domain', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Doorways.Niche'], null=True))
    ...
    def backwards(self, orm):
        ...
        db.create_table('doorsadmin_niche', (
            ...
            ('analyticsId', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True)),
            ('state', self.gf('django.db.models.fields.CharField')(default='normal', max_length=50)),
            ('piwikId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('cyclikId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        # Changing field 'XrumerBaseR.niche'
        db.alter_column('doorsadmin_xrumerbaser', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Niche'], null=True))

        # Changing field 'KeywordsSet.niche'
        db.alter_column('doorsadmin_keywordsset', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Niche'], null=True))

        # Changing field 'Doorway.niche'
        db.alter_column('doorsadmin_doorway', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Niche'], null=True))

        # Changing field 'SnippetsSet.niche'
        db.alter_column('doorsadmin_snippetsset', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Niche'], null=True))

        # Changing field 'Template.niche'
        db.alter_column('doorsadmin_template', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Niche'], null=True))

        # Changing field 'DoorwayTask.niche'
        db.alter_column('doorsadmin_doorwaytask', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Niche'], null=True))

        # Changing field 'SpamTask.niche'
        db.alter_column('doorsadmin_spamtask', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Niche'], null=True))

        # Changing field 'Domain.niche'
        db.alter_column('doorsadmin_domain', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Niche'], null=True))


    models = {
        'Doorways.niche': {
            'Meta': {'object_name': 'Niche', 'db_table': "'doorsadmin_niche'"},
        ...
        'doorsadmin.domain': {
            ...
            'niche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Doorways.Niche']", 'null': 'True', 'blank': 'True'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
        ...
        'doorsadmin.doorway': {
            ...
            'niche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Doorways.Niche']", 'null': 'True'}),
