...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NetPlan'
        db.create_table('doorsadmin_netplan', (
            ('net_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['doorsadmin.Net'], unique=True, primary_key=True)),
            ('netsCount', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True)),
        ))
        db.send_create_signal('doorsadmin', ['NetPlan'])

        # Adding field 'Net.netPlan'
        db.add_column('doorsadmin_net', 'netPlan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.NetPlan'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'NetPlan'
        db.delete_table('doorsadmin_netplan')

        # Deleting field 'Net.netPlan'
        db.delete_column('doorsadmin_net', 'netPlan_id')
