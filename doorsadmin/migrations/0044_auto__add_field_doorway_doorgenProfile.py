...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('doorsadmin_doorway', 'doorgenProfile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.DoorgenProfile'], null=True, blank=True), keep_default=False)
