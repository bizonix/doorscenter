...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SpamLink.anchor'
        db.add_column('doorsadmin_spamlink', 'anchor', self.gf('django.db.models.fields.CharField')(default='', max_length=500), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SpamLink.anchor'
        db.delete_column('doorsadmin_spamlink', 'anchor')
    ...
    models = {
        ...
        'doorsadmin.spamlink': {
            ...
            'anchor': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '500'}),
