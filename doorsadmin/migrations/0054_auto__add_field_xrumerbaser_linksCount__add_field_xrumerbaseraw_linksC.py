...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XrumerBaseR.linksCount'
        db.add_column('doorsadmin_xrumerbaser', 'linksCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'XrumerBaseRaw.linksCount'
        db.add_column('doorsadmin_xrumerbaseraw', 'linksCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XrumerBaseR.linksCount'
        db.delete_column('doorsadmin_xrumerbaser', 'linksCount')

        # Deleting field 'XrumerBaseRaw.linksCount'
        db.delete_column('doorsadmin_xrumerbaseraw', 'linksCount')
