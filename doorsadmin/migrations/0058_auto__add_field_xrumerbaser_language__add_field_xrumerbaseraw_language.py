...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XrumerBaseR.language'
        db.add_column('doorsadmin_xrumerbaser', 'language', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'XrumerBaseR.language'
        db.delete_column('doorsadmin_xrumerbaser', 'language')
    ...
    models = {
        ...
        'doorsadmin.xrumerbaser': {
            ...
            'lastError': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'linksCount': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'niche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doorsadmin.Niche']", 'null': 'True'}),
