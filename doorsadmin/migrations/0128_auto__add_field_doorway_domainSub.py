...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Doorway.domainSub'
        db.add_column('doorsadmin_doorway', 'domainSub', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Doorway.domainSub'
        db.delete_column('doorsadmin_doorway', 'domainSub')
