...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'XrumerProject.xrumerBaseR'
        db.alter_column('doorsadmin_xrumerproject', 'xrumerBaseR_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['doorsadmin.XrumerBaseR'], unique=True, null=True))

        # Adding unique constraint on 'XrumerProject', fields ['xrumerBaseR']
        db.create_unique('doorsadmin_xrumerproject', ['xrumerBaseR_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'XrumerProject', fields ['xrumerBaseR']
        db.delete_unique('doorsadmin_xrumerproject', ['xrumerBaseR_id'])

        # Changing field 'XrumerProject.xrumerBaseR'
        db.alter_column('doorsadmin_xrumerproject', 'xrumerBaseR_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.XrumerBaseR'], null=True))
