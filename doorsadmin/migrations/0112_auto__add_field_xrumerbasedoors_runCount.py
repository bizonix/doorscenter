...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XrumerBaseDoors.runCount'
        db.add_column('doorsadmin_xrumerbasedoors', 'runCount', self.gf('django.db.models.fields.IntegerField')(default=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XrumerBaseDoors.runCount'
        db.delete_column('doorsadmin_xrumerbasedoors', 'runCount')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 10, 17)', 'null': 'True', 'blank': 'True'}),
