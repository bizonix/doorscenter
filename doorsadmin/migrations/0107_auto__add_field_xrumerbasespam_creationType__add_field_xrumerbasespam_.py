...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XrumerBaseSpam.creationType'
        db.add_column('doorsadmin_xrumerbasespam', 'creationType', self.gf('django.db.models.fields.CharField')(default='post', max_length=50), keep_default=False)

        # Adding field 'XrumerBaseSpam.registerRun'
        db.add_column('doorsadmin_xrumerbasespam', 'registerRun', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'XrumerBaseSpam.registerRunDate'
        db.add_column('doorsadmin_xrumerbasespam', 'registerRunDate', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XrumerBaseSpam.creationType'
        db.delete_column('doorsadmin_xrumerbasespam', 'creationType')

        # Deleting field 'XrumerBaseSpam.registerRun'
        db.delete_column('doorsadmin_xrumerbasespam', 'registerRun')

        # Deleting field 'XrumerBaseSpam.registerRunDate'
        db.delete_column('doorsadmin_xrumerbasespam', 'registerRunDate')
    ...
    models = {
        ...
        'doorsadmin.xrumerbaseraw': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'baseNumber': ('django.db.models.fields.IntegerField', [], {'default': '158', 'unique': 'True'}),
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
