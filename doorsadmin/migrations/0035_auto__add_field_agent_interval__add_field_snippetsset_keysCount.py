...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Agent.interval'
        db.add_column('doorsadmin_agent', 'interval', self.gf('django.db.models.fields.IntegerField')(default=3, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Agent.interval'
        db.delete_column('doorsadmin_agent', 'interval')
    ...
    models = {
        ...
        'doorsadmin.snippetsset': {
            ...
            'keysCount': ('django.db.models.fields.IntegerField', [], {'default': '1000', 'null': 'True'}),
            'lastError': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
