...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Domain.makeSpam'
        db.add_column('doorsadmin_domain', 'makeSpam', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'SpamLink.makeSpam'
        db.add_column('doorsadmin_spamlink', 'makeSpam', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Domain.makeSpam'
        db.delete_column('doorsadmin_domain', 'makeSpam')

        # Deleting field 'SpamLink.makeSpam'
        db.delete_column('doorsadmin_spamlink', 'makeSpam')
