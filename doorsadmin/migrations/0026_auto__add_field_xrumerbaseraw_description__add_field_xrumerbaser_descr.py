...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XrumerBaseRaw.description'
        db.add_column('doorsadmin_xrumerbaseraw', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'XrumerBaseR.description'
        db.add_column('doorsadmin_xrumerbaser', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Doorway.description'
        db.add_column('doorsadmin_doorway', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'IPAddress.description'
        db.add_column('doorsadmin_ipaddress', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'SnippetsSet.description'
        db.add_column('doorsadmin_snippetsset', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'SpamTask.description'
        db.add_column('doorsadmin_spamtask', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'XrumerProject.description'
        db.add_column('doorsadmin_xrumerproject', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Host.description'
        db.add_column('doorsadmin_host', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'DoorwaySchedule.description'
        db.add_column('doorsadmin_doorwayschedule', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Domain.description'
        db.add_column('doorsadmin_domain', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XrumerBaseRaw.description'
        db.delete_column('doorsadmin_xrumerbaseraw', 'description')

        # Deleting field 'XrumerBaseR.description'
        db.delete_column('doorsadmin_xrumerbaser', 'description')

        # Deleting field 'Doorway.description'
        db.delete_column('doorsadmin_doorway', 'description')

        # Deleting field 'IPAddress.description'
        db.delete_column('doorsadmin_ipaddress', 'description')

        # Deleting field 'SnippetsSet.description'
        db.delete_column('doorsadmin_snippetsset', 'description')

        # Deleting field 'SpamTask.description'
        db.delete_column('doorsadmin_spamtask', 'description')

        # Deleting field 'XrumerProject.description'
        db.delete_column('doorsadmin_xrumerproject', 'description')

        # Deleting field 'Host.description'
        db.delete_column('doorsadmin_host', 'description')

        # Deleting field 'DoorwaySchedule.description'
        db.delete_column('doorsadmin_doorwayschedule', 'description')

        # Deleting field 'Domain.description'
        db.delete_column('doorsadmin_domain', 'description')
