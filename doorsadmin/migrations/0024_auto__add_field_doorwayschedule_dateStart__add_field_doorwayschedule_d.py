...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DoorwaySchedule.dateStart'
        db.add_column('doorsadmin_doorwayschedule', 'dateStart', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True), keep_default=False)

        # Adding field 'DoorwaySchedule.dateEnd'
        db.add_column('doorsadmin_doorwayschedule', 'dateEnd', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DoorwaySchedule.dateStart'
        db.delete_column('doorsadmin_doorwayschedule', 'dateStart')

        # Deleting field 'DoorwaySchedule.dateEnd'
        db.delete_column('doorsadmin_doorwayschedule', 'dateEnd')
    ...
    models = {
        ...
        'doorsadmin.doorwayschedule': {
            ...
            'dateStart': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
