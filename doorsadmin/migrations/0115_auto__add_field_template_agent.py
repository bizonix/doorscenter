...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Template.agent'
        db.add_column('doorsadmin_template', 'agent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Agent'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Template.agent'
        db.delete_column('doorsadmin_template', 'agent_id')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 11, 11)', 'null': 'True', 'blank': 'True'}),
        ...
        'doorsadmin.template': {
            ...
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'stateSimple': ('django.db.models.fields.CharField', [], {'default': "'new'", 'max_length': '50'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'classic'", 'max_length': '50', 'blank': 'True'})
        },
        'doorsadmin.trackers': {
