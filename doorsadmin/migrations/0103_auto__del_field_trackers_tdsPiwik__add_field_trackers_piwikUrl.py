...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Trackers.tdsPiwik'
        db.delete_column('doorsadmin_trackers', 'tdsPiwik')

        # Adding field 'Trackers.piwikUrl'
        db.add_column('doorsadmin_trackers', 'piwikUrl', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Trackers.tdsPiwik'
        db.add_column('doorsadmin_trackers', 'tdsPiwik', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Deleting field 'Trackers.piwikUrl'
        db.delete_column('doorsadmin_trackers', 'piwikUrl')
