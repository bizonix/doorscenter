...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'KeywordsSet.keysCount'
        db.delete_column('doorsadmin_keywordsset', 'keysCount')

        # Adding field 'KeywordsSet.keywordsCount'
        db.add_column('doorsadmin_keywordsset', 'keywordsCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'SnippetsSet.keysCount'
        db.delete_column('doorsadmin_snippetsset', 'keysCount')

        # Adding field 'SnippetsSet.keywordsCount'
        db.add_column('doorsadmin_snippetsset', 'keywordsCount', self.gf('django.db.models.fields.IntegerField')(default=1000, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'KeywordsSet.keysCount'
        db.add_column('doorsadmin_keywordsset', 'keysCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'KeywordsSet.keywordsCount'
        db.delete_column('doorsadmin_keywordsset', 'keywordsCount')

        # Adding field 'SnippetsSet.keysCount'
        db.add_column('doorsadmin_snippetsset', 'keysCount', self.gf('django.db.models.fields.IntegerField')(default=1000, null=True), keep_default=False)

        # Deleting field 'SnippetsSet.keywordsCount'
        db.delete_column('doorsadmin_snippetsset', 'keywordsCount')
