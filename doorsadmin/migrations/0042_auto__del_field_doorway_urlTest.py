...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Doorway.urlTest'
        db.delete_column('doorsadmin_doorway', 'urlTest')


    def backwards(self, orm):
        
        # Adding field 'Doorway.urlTest'
        db.add_column('doorsadmin_doorway', 'urlTest', self.gf('django.db.models.fields.URLField')(default='http://www.mail.ru', max_length=200, null=True, blank=True), keep_default=False)
