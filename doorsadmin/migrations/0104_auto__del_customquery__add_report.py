...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('doorsadmin_customquery')

        # Adding model 'Report'
        db.create_table('doorsadmin_report', (
            ...
            ('user', self.gf('django.db.models.fields.CharField')(default='admin', max_length=50)),
            ('password', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('database', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('sql', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal('doorsadmin', ['Report'])


    def backwards(self, orm):
        
        # Adding model 'CustomQuery'
        db.create_table('doorsadmin_customquery', (
            ('host', self.gf('django.db.models.fields.CharField')(default='localhost', max_length=50)),
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('sql', self.gf('django.db.models.fields.TextField')(default='')),
            ('database', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
        ...
        db.send_create_signal('doorsadmin', ['CustomQuery'])

        # Deleting model 'Report'
        db.delete_table('doorsadmin_report')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 9, 15)', 'null': 'True', 'blank': 'True'}),
