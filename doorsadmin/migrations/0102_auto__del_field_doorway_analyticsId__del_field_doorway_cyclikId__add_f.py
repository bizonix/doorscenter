...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Doorway.analyticsId'
        db.delete_column('doorsadmin_doorway', 'analyticsId')

        # Deleting field 'Doorway.cyclikId'
        db.delete_column('doorsadmin_doorway', 'cyclikId')

        # Adding field 'Doorway.trackers'
        db.add_column('doorsadmin_doorway', 'trackers', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Trackers'], null=True, blank=True), keep_default=False)
        ...
        # Deleting field 'NetPlan.analyticsId'
        db.delete_column('doorsadmin_netplan', 'analyticsId')

        # Deleting field 'NetPlan.cyclikId'
        db.delete_column('doorsadmin_netplan', 'cyclikId')

        # Adding field 'NetPlan.trackers'
        db.add_column('doorsadmin_netplan', 'trackers', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Trackers'], null=True, blank=True), keep_default=False)

        # Adding field 'NetPlan.tdsId'
        db.add_column('doorsadmin_netplan', 'tdsId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Net.analyticsId'
        db.delete_column('doorsadmin_net', 'analyticsId')

        # Deleting field 'Net.cyclikId'
        db.delete_column('doorsadmin_net', 'cyclikId')

        # Adding field 'Net.trackers'
        db.add_column('doorsadmin_net', 'trackers', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Trackers'], null=True, blank=True), keep_default=False)

        # Adding field 'Net.tdsId'
        db.add_column('doorsadmin_net', 'tdsId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Niche.analyticsId'
        db.delete_column('doorsadmin_niche', 'analyticsId')

        # Deleting field 'Niche.cyclikId'
        db.delete_column('doorsadmin_niche', 'cyclikId')

        # Adding field 'Niche.trackers'
        db.add_column('doorsadmin_niche', 'trackers', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Trackers'], null=True, blank=True), keep_default=False)

        # Adding field 'Niche.tdsId'
        db.add_column('doorsadmin_niche', 'tdsId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Doorway.analyticsId'
        db.add_column('doorsadmin_doorway', 'analyticsId', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Doorway.cyclikId'
        db.add_column('doorsadmin_doorway', 'cyclikId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Doorway.trackers'
        db.delete_column('doorsadmin_doorway', 'trackers_id')

        # Deleting field 'Doorway.tdsId'
        db.delete_column('doorsadmin_doorway', 'tdsId')

        # Adding field 'NetPlan.analyticsId'
        db.add_column('doorsadmin_netplan', 'analyticsId', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'NetPlan.cyclikId'
        db.add_column('doorsadmin_netplan', 'cyclikId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'NetPlan.trackers'
        db.delete_column('doorsadmin_netplan', 'trackers_id')

        # Deleting field 'NetPlan.tdsId'
        db.delete_column('doorsadmin_netplan', 'tdsId')

        # Adding field 'Net.analyticsId'
        db.add_column('doorsadmin_net', 'analyticsId', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Net.cyclikId'
        db.add_column('doorsadmin_net', 'cyclikId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Net.trackers'
        db.delete_column('doorsadmin_net', 'trackers_id')

        # Deleting field 'Net.tdsId'
        db.delete_column('doorsadmin_net', 'tdsId')

        # Adding field 'Niche.analyticsId'
        db.add_column('doorsadmin_niche', 'analyticsId', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Niche.cyclikId'
        db.add_column('doorsadmin_niche', 'cyclikId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Niche.trackers'
        db.delete_column('doorsadmin_niche', 'trackers_id')

        # Deleting field 'Niche.tdsId'
        db.delete_column('doorsadmin_niche', 'tdsId')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 9, 11)', 'null': 'True', 'blank': 'True'}),
            ...
            'maxDoorsCount': ('django.db.models.fields.IntegerField', [], {'default': '1', 'blank': 'True'}),
        ...
        'doorsadmin.doorway': {
            ...
            'trackers': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doorsadmin.Trackers']", 'null': 'True', 'blank': 'True'})
        },
        'doorsadmin.event': {
        ...
        'doorsadmin.trackers': {
            ...
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'stateSimple': ('django.db.models.fields.CharField', [], {'default': "'new'", 'max_length': '50'}),
            'tdsPiwik': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'tdsUrl': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'})
        },
        'doorsadmin.xrumerbaser': {
            'Meta': {'object_name': 'XrumerBaseR'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'agent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doorsadmin.Agent']", 'null': 'True', 'blank': 'True'}),
            'baseNumber': ('django.db.models.fields.IntegerField', [], {'default': '84', 'unique': 'True'}),
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
