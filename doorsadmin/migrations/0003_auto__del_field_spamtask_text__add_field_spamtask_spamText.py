...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SpamTask.text'
        db.delete_column('doorsadmin_spamtask', 'text')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'SpamTask.text'
        db.add_column('doorsadmin_spamtask', 'text', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
