...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DoorgenProfile.localFile'
        db.delete_column('doorsadmin_doorgenprofile', 'localFile')

        # Adding field 'DoorgenProfile.settings'
        db.add_column('doorsadmin_doorgenprofile', 'settings', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'DoorgenProfile.localFile'
        db.add_column('doorsadmin_doorgenprofile', 'localFile', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Deleting field 'DoorgenProfile.settings'
        db.delete_column('doorsadmin_doorgenprofile', 'settings')
