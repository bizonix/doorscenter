...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Domain.useOwnDNS'
        db.add_column('doorsadmin_domain', 'useOwnDNS', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Domain.useOwnDNS'
        db.delete_column('doorsadmin_domain', 'useOwnDNS')
