...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Doorway.doorwayTask'
        db.delete_column('doorsadmin_doorway', 'doorwayTask_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Doorway.doorwayTask'
        db.add_column('doorsadmin_doorway', 'doorwayTask', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.DoorwaySchedule'], null=True, blank=True), keep_default=False)
