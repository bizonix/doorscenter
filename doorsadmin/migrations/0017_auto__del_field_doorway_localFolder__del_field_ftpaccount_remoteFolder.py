...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Doorway.localFolder'
        db.delete_column('doorsadmin_doorway', 'localFolder')

        # Deleting field 'FTPAccount.remoteFolder'
        db.delete_column('doorsadmin_ftpaccount', 'remoteFolder')

        # Deleting field 'DoorwaySchedule.pagesCountFrom'
        db.delete_column('doorsadmin_doorwayschedule', 'pagesCountFrom')

        # Deleting field 'DoorwaySchedule.pagesCountTo'
        db.delete_column('doorsadmin_doorwayschedule', 'pagesCountTo')

        # Adding field 'DoorwaySchedule.minPagesCount'
        db.add_column('doorsadmin_doorwayschedule', 'minPagesCount', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'DoorwaySchedule.maxPagesCount'
        db.add_column('doorsadmin_doorwayschedule', 'maxPagesCount', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Doorway.localFolder'
        db.add_column('doorsadmin_doorway', 'localFolder', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'FTPAccount.remoteFolder'
        db.add_column('doorsadmin_ftpaccount', 'remoteFolder', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'DoorwaySchedule.pagesCountFrom'
        db.add_column('doorsadmin_doorwayschedule', 'pagesCountFrom', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'DoorwaySchedule.pagesCountTo'
        db.add_column('doorsadmin_doorwayschedule', 'pagesCountTo', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
    ...
    models = {
        ...
        'doorsadmin.doorway': {
            ...
            'doorwayTask': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doorsadmin.DoorwaySchedule']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
