...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XrumerBaseR.xrumerBaseRaw'
        db.add_column('doorsadmin_xrumerbaser', 'xrumerBaseRaw', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.XrumerBaseRaw'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XrumerBaseR.xrumerBaseRaw'
        db.delete_column('doorsadmin_xrumerbaser', 'xrumerBaseRaw_id')
