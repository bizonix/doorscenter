...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Domain.autoSubdomains'
        db.add_column('doorsadmin_domain', 'autoSubdomains', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Doorway.redirectDelay'
        db.add_column('doorsadmin_doorway', 'redirectDelay', self.gf('django.db.models.fields.IntegerField')(default=7), keep_default=False)

        # Adding field 'Net.redirectDelay'
        db.add_column('doorsadmin_net', 'redirectDelay', self.gf('django.db.models.fields.IntegerField')(default=7), keep_default=False)

        # Adding field 'NetPlan.redirectDelay'
        db.add_column('doorsadmin_netplan', 'redirectDelay', self.gf('django.db.models.fields.IntegerField')(default=7), keep_default=False)

        # Adding field 'Niche.redirectDelay'
        db.add_column('doorsadmin_niche', 'redirectDelay', self.gf('django.db.models.fields.IntegerField')(default=7), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Domain.autoSubdomains'
        db.delete_column('doorsadmin_domain', 'autoSubdomains')

        # Deleting field 'Doorway.redirectDelay'
        db.delete_column('doorsadmin_doorway', 'redirectDelay')

        # Deleting field 'Net.redirectDelay'
        db.delete_column('doorsadmin_net', 'redirectDelay')

        # Deleting field 'NetPlan.redirectDelay'
        db.delete_column('doorsadmin_netplan', 'redirectDelay')

        # Deleting field 'Niche.redirectDelay'
        db.delete_column('doorsadmin_niche', 'redirectDelay')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'autoSubdomains': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 1, 11)', 'null': 'True', 'blank': 'True'}),
        ...
        'doorsadmin.doorway': {
            ...
            'redirectDelay': ('django.db.models.fields.IntegerField', [], {'default': '7'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
