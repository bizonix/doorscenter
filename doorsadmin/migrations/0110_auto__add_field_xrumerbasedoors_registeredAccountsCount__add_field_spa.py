...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XrumerBaseDoors.registeredAccountsCount'
        db.add_column('doorsadmin_xrumerbasedoors', 'registeredAccountsCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'SpamTask.registeredAccountsCount'
        db.add_column('doorsadmin_spamtask', 'registeredAccountsCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'XrumerBaseSpam.registeredAccountsCount'
        db.add_column('doorsadmin_xrumerbasespam', 'registeredAccountsCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'XrumerBaseProfiles.registeredAccountsCount'
        db.add_column('doorsadmin_xrumerbaseprofiles', 'registeredAccountsCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XrumerBaseDoors.registeredAccountsCount'
        db.delete_column('doorsadmin_xrumerbasedoors', 'registeredAccountsCount')

        # Deleting field 'SpamTask.registeredAccountsCount'
        db.delete_column('doorsadmin_spamtask', 'registeredAccountsCount')

        # Deleting field 'XrumerBaseSpam.registeredAccountsCount'
        db.delete_column('doorsadmin_xrumerbasespam', 'registeredAccountsCount')

        # Deleting field 'XrumerBaseProfiles.registeredAccountsCount'
        db.delete_column('doorsadmin_xrumerbaseprofiles', 'registeredAccountsCount')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 10, 13)', 'null': 'True', 'blank': 'True'}),
