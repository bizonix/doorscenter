...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Agent.used'
        db.add_column('doorsadmin_agent', 'used', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Agent.used'
        db.delete_column('doorsadmin_agent', 'used')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'maxDoorsCount': ('django.db.models.fields.IntegerField', [], {'default': '3', 'blank': 'True'}),
