...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Host.controlPanelServerNumber'
        db.delete_column('doorsadmin_host', 'controlPanelServerNumber')

        # Adding field 'Host.controlPanelServerId'
        db.add_column('doorsadmin_host', 'controlPanelServerId', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Host.controlPanelServerNumber'
        db.add_column('doorsadmin_host', 'controlPanelServerNumber', self.gf('django.db.models.fields.IntegerField')(default=1, blank=True), keep_default=False)

        # Deleting field 'Host.controlPanelServerId'
        db.delete_column('doorsadmin_host', 'controlPanelServerId')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 7, 8)', 'null': 'True', 'blank': 'True'}),
