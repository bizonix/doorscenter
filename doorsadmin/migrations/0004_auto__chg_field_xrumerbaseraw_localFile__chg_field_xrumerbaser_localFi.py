...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'XrumerBaseRaw.localFile'
        db.alter_column('doorsadmin_xrumerbaseraw', 'localFile', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'XrumerBaseR.localFile'
        db.alter_column('doorsadmin_xrumerbaser', 'localFile', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # Changing field 'XrumerBaseRaw.localFile'
        db.alter_column('doorsadmin_xrumerbaseraw', 'localFile', self.gf('django.db.models.fields.CharField')(default=1, max_length=200))

        # Changing field 'XrumerBaseR.localFile'
        db.alter_column('doorsadmin_xrumerbaser', 'localFile', self.gf('django.db.models.fields.CharField')(default=1, max_length=200))
