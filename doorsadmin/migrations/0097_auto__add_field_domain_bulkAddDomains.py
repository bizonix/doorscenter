...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Domain.bulkAddDomains'
        db.add_column('doorsadmin_domain', 'bulkAddDomains', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Domain.bulkAddDomains'
        db.delete_column('doorsadmin_domain', 'bulkAddDomains')
