...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DoorwaySchedule.minSpamLinksCount'
        db.add_column('doorsadmin_doorwayschedule', 'minSpamLinksCount', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'DoorwaySchedule.maxSpamLinksCount'
        db.add_column('doorsadmin_doorwayschedule', 'maxSpamLinksCount', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DoorwaySchedule.minSpamLinksCount'
        db.delete_column('doorsadmin_doorwayschedule', 'minSpamLinksCount')

        # Deleting field 'DoorwaySchedule.maxSpamLinksCount'
        db.delete_column('doorsadmin_doorwayschedule', 'maxSpamLinksCount')
    ...
    models = {
        ...
        'doorsadmin.doorway': {
            ...
            'doorgenProfile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doorsadmin.DoorgenProfile']", 'null': 'True', 'blank': 'True'}),
        ...
        'doorsadmin.doorwayschedule': {
            ...
            'maxSpamLinksCount': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'minPagesCount': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'minSpamLinksCount': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'net': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doorsadmin.Net']", 'null': 'True'}),
            'niche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doorsadmin.Niche']", 'null': 'True'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'stateSimple': ('django.db.models.fields.CharField', [], {'default': "'new'", 'max_length': '50'}),
