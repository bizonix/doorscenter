...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SnippetsSet.interval'
        db.add_column('doorsadmin_snippetsset', 'interval', self.gf('django.db.models.fields.IntegerField')(default=24, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SnippetsSet.interval'
        db.delete_column('doorsadmin_snippetsset', 'interval')
    ...
    models = {
        ...
        'doorsadmin.snippetsset': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interval': ('django.db.models.fields.IntegerField', [], {'default': '24', 'null': 'True', 'blank': 'True'}),
            'lastError': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
