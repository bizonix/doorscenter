...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Agent.host'
        db.add_column('doorsadmin_agent', 'host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Host'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Agent.host'
        db.delete_column('doorsadmin_agent', 'host_id')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 1, 18)', 'null': 'True', 'blank': 'True'}),
