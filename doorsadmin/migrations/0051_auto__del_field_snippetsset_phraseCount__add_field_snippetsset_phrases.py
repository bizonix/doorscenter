...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SnippetsSet.phraseCount'
        db.delete_column('doorsadmin_snippetsset', 'phraseCount')

        # Adding field 'SnippetsSet.phrasesList'
        db.add_column('doorsadmin_snippetsset', 'phrasesList', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'SnippetsSet.phrasesCount'
        db.add_column('doorsadmin_snippetsset', 'phrasesCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SnippetsSet.phraseCount'
        db.add_column('doorsadmin_snippetsset', 'phraseCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'SnippetsSet.phrasesList'
        db.delete_column('doorsadmin_snippetsset', 'phrasesList')

        # Deleting field 'SnippetsSet.phrasesCount'
        db.delete_column('doorsadmin_snippetsset', 'phrasesCount')
