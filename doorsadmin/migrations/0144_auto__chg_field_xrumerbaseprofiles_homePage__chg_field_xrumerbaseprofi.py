...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'XrumerBaseProfiles.homePage'
        db.alter_column('doorsadmin_xrumerbaseprofiles', 'homePage', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'XrumerBaseProfiles.signature'
        db.alter_column('doorsadmin_xrumerbaseprofiles', 'signature', self.gf('django.db.models.fields.CharField')(max_length=250))


    def backwards(self, orm):
        
        # Changing field 'XrumerBaseProfiles.homePage'
        db.alter_column('doorsadmin_xrumerbaseprofiles', 'homePage', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'XrumerBaseProfiles.signature'
        db.alter_column('doorsadmin_xrumerbaseprofiles', 'signature', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 4, 17)', 'null': 'True', 'blank': 'True'}),
