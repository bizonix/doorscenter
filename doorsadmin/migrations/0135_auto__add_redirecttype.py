...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RedirectType'
        db.create_table('doorsadmin_redirecttype', (
        ...
        db.send_create_signal('doorsadmin', ['RedirectType'])


    def backwards(self, orm):
        
        # Deleting model 'RedirectType'
        db.delete_table('doorsadmin_redirecttype')
