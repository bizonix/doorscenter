...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DoorwaySchedule.doorsToday'
        db.add_column('doorsadmin_doorwayschedule', 'doorsToday', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DoorwaySchedule.doorsToday'
        db.delete_column('doorsadmin_doorwayschedule', 'doorsToday')
