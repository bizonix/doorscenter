...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Domain.dateBan'
        db.add_column('doorsadmin_domain', 'dateBan', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Domain.drop'
        db.add_column('doorsadmin_domain', 'drop', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Domain.banned'
        db.add_column('doorsadmin_domain', 'banned', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Domain.dateBan'
        db.delete_column('doorsadmin_domain', 'dateBan')

        # Deleting field 'Domain.drop'
        db.delete_column('doorsadmin_domain', 'drop')

        # Deleting field 'Domain.banned'
        db.delete_column('doorsadmin_domain', 'banned')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 4, 5)', 'null': 'True', 'blank': 'True'}),
