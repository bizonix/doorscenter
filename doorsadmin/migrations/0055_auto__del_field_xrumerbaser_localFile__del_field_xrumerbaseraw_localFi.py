...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'XrumerBaseR.localFile'
        db.delete_column('doorsadmin_xrumerbaser', 'localFile')

        # Deleting field 'XrumerBaseRaw.localFile'
        db.delete_column('doorsadmin_xrumerbaseraw', 'localFile')


    def backwards(self, orm):
        
        # Adding field 'XrumerBaseR.localFile'
        db.add_column('doorsadmin_xrumerbaser', 'localFile', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'XrumerBaseRaw.localFile'
        db.add_column('doorsadmin_xrumerbaseraw', 'localFile', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)
