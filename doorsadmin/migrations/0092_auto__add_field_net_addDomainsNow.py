...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Net.addDomainsNow'
        db.add_column('doorsadmin_net', 'addDomainsNow', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Net.addDomainsNow'
        db.delete_column('doorsadmin_net', 'addDomainsNow')
