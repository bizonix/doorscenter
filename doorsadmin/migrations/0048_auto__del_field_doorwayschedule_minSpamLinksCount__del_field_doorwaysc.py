...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('doorsadmin_doorwayschedule', 'minSpamLinksPercent', self.gf('django.db.models.fields.FloatField')(default=1), keep_default=False)

        # Adding field 'DoorwaySchedule.maxSpamLinksPercent'
        db.add_column('doorsadmin_doorwayschedule', 'maxSpamLinksPercent', self.gf('django.db.models.fields.IntegerField')(default=2.5), keep_default=False)
    ...
    models = {
        ...
        'doorsadmin.doorwayschedule': {
            ...
            'maxSpamLinksPercent': ('django.db.models.fields.IntegerField', [], {'default': '2.5'}),
