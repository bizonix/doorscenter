...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Doorway.spamLinksList'
        db.delete_column('doorsadmin_doorway', 'spamLinksList')

        # Deleting field 'SpamTask.spamLinksList'
        db.delete_column('doorsadmin_spamtask', 'spamLinksList')

        # Adding field 'XrumerBaseR.spamTaskDomainsMin'
        db.add_column('doorsadmin_xrumerbaser', 'spamTaskDomainsMin', self.gf('django.db.models.fields.IntegerField')(default=3), keep_default=False)

        # Adding field 'XrumerBaseR.spamTaskDomainsMax'
        db.add_column('doorsadmin_xrumerbaser', 'spamTaskDomainsMax', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)

        # Adding field 'XrumerBaseR.nextSpamTaskDomainsCount'
        db.add_column('doorsadmin_xrumerbaser', 'nextSpamTaskDomainsCount', self.gf('django.db.models.fields.IntegerField')(default=4), keep_default=False)

        # Adding field 'XrumerBaseR.spamTaskDomainLinksMin'
        db.add_column('doorsadmin_xrumerbaser', 'spamTaskDomainLinksMin', self.gf('django.db.models.fields.IntegerField')(default=3), keep_default=False)

        # Adding field 'XrumerBaseR.spamTaskDomainLinksMax'
        db.add_column('doorsadmin_xrumerbaser', 'spamTaskDomainLinksMax', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Doorway.spamLinksList'
        db.add_column('doorsadmin_doorway', 'spamLinksList', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'SpamTask.spamLinksList'
        db.add_column('doorsadmin_spamtask', 'spamLinksList', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'XrumerBaseR.spamTaskDomainsMin'
        db.delete_column('doorsadmin_xrumerbaser', 'spamTaskDomainsMin')

        # Deleting field 'XrumerBaseR.spamTaskDomainsMax'
        db.delete_column('doorsadmin_xrumerbaser', 'spamTaskDomainsMax')

        # Deleting field 'XrumerBaseR.nextSpamTaskDomainsCount'
        db.delete_column('doorsadmin_xrumerbaser', 'nextSpamTaskDomainsCount')

        # Deleting field 'XrumerBaseR.spamTaskDomainLinksMin'
        db.delete_column('doorsadmin_xrumerbaser', 'spamTaskDomainLinksMin')

        # Deleting field 'XrumerBaseR.spamTaskDomainLinksMax'
        db.delete_column('doorsadmin_xrumerbaser', 'spamTaskDomainLinksMax')
