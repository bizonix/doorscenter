...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XrumerBaseRaw.parseParams'
        db.add_column('doorsadmin_xrumerbaseraw', 'parseParams', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XrumerBaseRaw.parseParams'
        db.delete_column('doorsadmin_xrumerbaseraw', 'parseParams')
