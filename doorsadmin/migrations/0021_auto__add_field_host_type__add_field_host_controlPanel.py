...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('doorsadmin_host', 'type', self.gf('django.db.models.fields.CharField')(default='shared', max_length=50, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('doorsadmin_host', 'type')
