...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Agent.remarks'
        db.add_column('doorsadmin_agent', 'remarks', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Agent.lastError'
        db.add_column('doorsadmin_agent', 'lastError', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Agent.dateAdded'
        db.add_column('doorsadmin_agent', 'dateAdded', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)

        # Adding field 'Agent.dateChanged'
        db.add_column('doorsadmin_agent', 'dateChanged', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, null=True, blank=True), keep_default=False)

        # Adding field 'Agent.agentType'
        db.add_column('doorsadmin_agent', 'agentType', self.gf('django.db.models.fields.CharField')(default=1, max_length=50), keep_default=False)

        # Adding field 'Agent.description'
        db.add_column('doorsadmin_agent', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Agent.remarks'
        db.delete_column('doorsadmin_agent', 'remarks')

        # Deleting field 'Agent.lastError'
        db.delete_column('doorsadmin_agent', 'lastError')

        # Deleting field 'Agent.dateAdded'
        db.delete_column('doorsadmin_agent', 'dateAdded')

        # Deleting field 'Agent.dateChanged'
        db.delete_column('doorsadmin_agent', 'dateChanged')

        # Deleting field 'Agent.agentType'
        db.delete_column('doorsadmin_agent', 'agentType')

        # Deleting field 'Agent.description'
        db.delete_column('doorsadmin_agent', 'description')
