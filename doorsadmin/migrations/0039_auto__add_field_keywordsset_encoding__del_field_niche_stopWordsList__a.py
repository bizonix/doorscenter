...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'KeywordsSet.encoding'
        db.add_column('doorsadmin_keywordsset', 'encoding', self.gf('django.db.models.fields.CharField')(default='utf-8', max_length=50), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'KeywordsSet.encoding'
        db.delete_column('doorsadmin_keywordsset', 'encoding')
