...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field linkedDomains on 'Domain'
        db.create_table('doorsadmin_domain_linkedDomains', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_domain', models.ForeignKey(orm['doorsadmin.domain'], null=False)),
            ('to_domain', models.ForeignKey(orm['doorsadmin.domain'], null=False))
        ))
        db.create_unique('doorsadmin_domain_linkedDomains', ['from_domain_id', 'to_domain_id'])


    def backwards(self, orm):
        
        # Adding field 'Domain.netLink2'
        db.add_column('doorsadmin_domain', 'netLink2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='netLinks2', null=True, to=orm['doorsadmin.Domain'], blank=True), keep_default=False)

        # Adding field 'Domain.netLink1'
        db.add_column('doorsadmin_domain', 'netLink1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='netLinks1', null=True, to=orm['doorsadmin.Domain'], blank=True), keep_default=False)

        # Removing M2M table for field linkedDomains on 'Domain'
        db.delete_table('doorsadmin_domain_linkedDomains')
