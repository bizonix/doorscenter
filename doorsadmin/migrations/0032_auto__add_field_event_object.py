...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.object'
        db.add_column('doorsadmin_event', 'object', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.object'
        db.delete_column('doorsadmin_event', 'object')
