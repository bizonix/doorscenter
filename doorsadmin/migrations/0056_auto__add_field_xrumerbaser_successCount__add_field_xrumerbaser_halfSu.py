...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XrumerBaseR.successCount'
        db.add_column('doorsadmin_xrumerbaser', 'successCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'XrumerBaseR.halfSuccessCount'
        db.add_column('doorsadmin_xrumerbaser', 'halfSuccessCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'XrumerBaseR.failsCount'
        db.add_column('doorsadmin_xrumerbaser', 'failsCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'XrumerBaseR.profilesCount'
        db.add_column('doorsadmin_xrumerbaser', 'profilesCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'XrumerBaseR.subject'
        db.add_column('doorsadmin_xrumerbaser', 'subject', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XrumerBaseR.successCount'
        db.delete_column('doorsadmin_xrumerbaser', 'successCount')

        # Deleting field 'XrumerBaseR.halfSuccessCount'
        db.delete_column('doorsadmin_xrumerbaser', 'halfSuccessCount')

        # Deleting field 'XrumerBaseR.failsCount'
        db.delete_column('doorsadmin_xrumerbaser', 'failsCount')

        # Deleting field 'XrumerBaseR.profilesCount'
        db.delete_column('doorsadmin_xrumerbaser', 'profilesCount')

        # Deleting field 'XrumerBaseR.subject'
        db.delete_column('doorsadmin_xrumerbaser', 'subject')
    ...
    models = {
        ...
        'doorsadmin.xrumerbaser': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastError': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'linksCount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'niche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doorsadmin.Niche']", 'null': 'True'}),
