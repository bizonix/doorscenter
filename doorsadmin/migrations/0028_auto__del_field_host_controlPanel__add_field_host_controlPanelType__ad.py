...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Host.controlPanel'
        db.delete_column('doorsadmin_host', 'controlPanel')

        # Adding field 'Host.controlPanelType'
        db.add_column('doorsadmin_host', 'controlPanelType', self.gf('django.db.models.fields.CharField')(default='none', max_length=50, blank=True), keep_default=False)

        # Adding field 'Host.controlPanelUrl'
        db.add_column('doorsadmin_host', 'controlPanelUrl', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Host.controlPanel'
        db.add_column('doorsadmin_host', 'controlPanel', self.gf('django.db.models.fields.CharField')(default='none', max_length=50, blank=True), keep_default=False)

        # Deleting field 'Host.controlPanelType'
        db.delete_column('doorsadmin_host', 'controlPanelType')

        # Deleting field 'Host.controlPanelUrl'
        db.delete_column('doorsadmin_host', 'controlPanelUrl')
