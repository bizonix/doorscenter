...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Doorway.allLinksList'
        db.delete_column('doorsadmin_doorway', 'allLinksList')

        # Adding field 'Doorway.netLinksList'
        db.add_column('doorsadmin_doorway', 'netLinksList', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Doorway.allLinksList'
        db.add_column('doorsadmin_doorway', 'allLinksList', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'Doorway.netLinksList'
        db.delete_column('doorsadmin_doorway', 'netLinksList')
