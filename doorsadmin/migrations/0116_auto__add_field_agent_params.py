...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Agent.params'
        db.add_column('doorsadmin_agent', 'params', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Agent.params'
        db.delete_column('doorsadmin_agent', 'params')
