...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Domain.net'
        db.add_column('doorsadmin_domain', 'net', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Net'], null=True), keep_default=False)

        # Adding field 'Domain.netLink1'
        db.add_column('doorsadmin_domain', 'netLink1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='netLinks1', null=True, to=orm['doorsadmin.Domain']), keep_default=False)

        # Adding field 'Domain.netLink2'
        db.add_column('doorsadmin_domain', 'netLink2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='netLinks2', null=True, to=orm['doorsadmin.Domain']), keep_default=False)

        # Adding field 'Domain.netLevel'
        db.add_column('doorsadmin_domain', 'netLevel', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Deleting field 'Doorway.net'
        db.delete_column('doorsadmin_doorway', 'net_id')

        # Deleting field 'Net.netLinksList'
        db.delete_column('doorsadmin_net', 'netLinksList')

        # Adding field 'Net.settings'
        db.add_column('doorsadmin_net', 'settings', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Domain.net'
        db.delete_column('doorsadmin_domain', 'net_id')

        # Deleting field 'Domain.netLink1'
        db.delete_column('doorsadmin_domain', 'netLink1_id')

        # Deleting field 'Domain.netLink2'
        db.delete_column('doorsadmin_domain', 'netLink2_id')

        # Deleting field 'Domain.netLevel'
        db.delete_column('doorsadmin_domain', 'netLevel')

        # Adding field 'Doorway.net'
        db.add_column('doorsadmin_doorway', 'net', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Net'], null=True), keep_default=False)

        # Adding field 'Net.netLinksList'
        db.add_column('doorsadmin_net', 'netLinksList', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'Net.settings'
        db.delete_column('doorsadmin_net', 'settings')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'netLink1': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'netLinks1'", 'null': 'True', 'to': "orm['doorsadmin.Domain']"}),
            'netLink2': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'netLinks2'", 'null': 'True', 'to': "orm['doorsadmin.Domain']"}),
        ...
        'doorsadmin.xrumerbaser': {
            ...
            'lastError': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'linksCount': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'niche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doorsadmin.Niche']", 'null': 'True'}),
