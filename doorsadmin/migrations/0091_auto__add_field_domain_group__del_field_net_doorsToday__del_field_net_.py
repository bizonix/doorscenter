...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Domain.group'
        db.add_column('doorsadmin_domain', 'group', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)
        ...
        # Adding field 'Net.domainGroup'
        db.add_column('doorsadmin_net', 'domainGroup', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'Net.domainsPerDay'
        db.add_column('doorsadmin_net', 'domainsPerDay', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Domain.group'
        db.delete_column('doorsadmin_domain', 'group')
        ...
        # Deleting field 'Net.domainGroup'
        db.delete_column('doorsadmin_net', 'domainGroup')

        # Deleting field 'Net.domainsPerDay'
        db.delete_column('doorsadmin_net', 'domainsPerDay')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 8, 21)', 'null': 'True', 'blank': 'True'}),
