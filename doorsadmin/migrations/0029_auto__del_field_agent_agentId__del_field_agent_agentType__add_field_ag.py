...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Agent.agentId'
        db.delete_column('doorsadmin_agent', 'agentId')

        # Deleting field 'Agent.agentType'
        db.delete_column('doorsadmin_agent', 'agentType')

        # Adding field 'Agent.type'
        db.add_column('doorsadmin_agent', 'type', self.gf('django.db.models.fields.CharField')(default='doorgen', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Agent.agentId'
        db.add_column('doorsadmin_agent', 'agentId', self.gf('django.db.models.fields.IntegerField')(default=1, unique=True), keep_default=False)

        # Adding field 'Agent.agentType'
        db.add_column('doorsadmin_agent', 'agentType', self.gf('django.db.models.fields.CharField')(default='doorgen', max_length=50), keep_default=False)

        # Deleting field 'Agent.type'
        db.delete_column('doorsadmin_agent', 'type')
