...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Doorway.piwikId'
        db.delete_column('doorsadmin_doorway', 'piwikId')

        # Deleting field 'Net.piwikId'
        db.delete_column('doorsadmin_net', 'piwikId')

        # Deleting field 'NetPlan.piwikId'
        db.delete_column('doorsadmin_netplan', 'piwikId')

        # Deleting field 'Niche.piwikId'
        db.delete_column('doorsadmin_niche', 'piwikId')


    def backwards(self, orm):
        
        # Adding field 'Doorway.piwikId'
        db.add_column('doorsadmin_doorway', 'piwikId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Net.piwikId'
        db.add_column('doorsadmin_net', 'piwikId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'NetPlan.piwikId'
        db.add_column('doorsadmin_netplan', 'piwikId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Niche.piwikId'
        db.add_column('doorsadmin_niche', 'piwikId', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 12, 25)', 'null': 'True', 'blank': 'True'}),
