...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'KeywordsSet.language'
        db.add_column('doorsadmin_keywordsset', 'language', self.gf('django.db.models.fields.CharField')(default='russian', max_length=50), keep_default=False)

        # Adding field 'Template.type'
        db.add_column('doorsadmin_template', 'type', self.gf('django.db.models.fields.CharField')(default='none', max_length=50, blank=True), keep_default=False)

        # Adding field 'Niche.stopWordsList'
        db.add_column('doorsadmin_niche', 'stopWordsList', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'KeywordsSet.language'
        db.delete_column('doorsadmin_keywordsset', 'language')

        # Deleting field 'Template.type'
        db.delete_column('doorsadmin_template', 'type')

        # Deleting field 'Niche.stopWordsList'
        db.delete_column('doorsadmin_niche', 'stopWordsList')
