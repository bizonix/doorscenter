...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'SpamLinks'
        db.delete_table('doorsadmin_spamlinks')

        # Adding model 'SpamLink'
        db.create_table('doorsadmin_spamlink', (
            ...
            ('doorway', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Doorway'])),
        ))
        db.send_create_signal('doorsadmin', ['SpamLink'])


    def backwards(self, orm):
        
        # Adding model 'SpamLinks'
        db.create_table('doorsadmin_spamlinks', (
            ('url', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('doorway', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Doorway'])),
            ('done', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('doorsadmin', ['SpamLinks'])

        # Deleting model 'SpamLink'
        db.delete_table('doorsadmin_spamlink')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 5, 26)', 'null': 'True', 'blank': 'True'}),
