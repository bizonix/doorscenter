...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Agent.dateLastPing'
        db.add_column('doorsadmin_agent', 'dateLastPing', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Agent.dateLastPing'
        db.delete_column('doorsadmin_agent', 'dateLastPing')
