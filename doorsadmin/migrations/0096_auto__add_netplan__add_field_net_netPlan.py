...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('doorsadmin_netplan', (
            ...
            ('keywordsSet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.KeywordsSet'], null=True, blank=True)),
            ('minPagesCount', self.gf('django.db.models.fields.IntegerField')(default=500, null=True)),
            ('maxPagesCount', self.gf('django.db.models.fields.IntegerField')(default=900, null=True)),
            ('minSpamLinksPercent', self.gf('django.db.models.fields.FloatField')(default=4)),
            ('maxSpamLinksPercent', self.gf('django.db.models.fields.FloatField')(default=5)),
            ('settings', self.gf('django.db.models.fields.TextField')(default='#gen', blank=True)),
            ('makeSpam', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('domainGroup', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True)),
            ('domainsPerDay', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('doorsPerDay', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ...
            ('netsCount', self.gf('django.db.models.fields.IntegerField')(default=5, null=True, blank=True)),
            ('generateNetsNow', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
        ))
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 9, 4)', 'null': 'True', 'blank': 'True'}),
