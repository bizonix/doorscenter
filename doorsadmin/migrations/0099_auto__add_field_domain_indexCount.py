...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Domain.indexCount'
        db.add_column('doorsadmin_domain', 'indexCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Domain.indexCount'
        db.delete_column('doorsadmin_domain', 'indexCount')
