...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('doorsadmin_trackers')
    ...
    def backwards(self, orm):
        ...
        db.create_table('doorsadmin_trackers', (
            ('tdsUrl', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ...
            ('piwikUrl', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
        ...
        db.send_create_signal('doorsadmin', ['Trackers'])
