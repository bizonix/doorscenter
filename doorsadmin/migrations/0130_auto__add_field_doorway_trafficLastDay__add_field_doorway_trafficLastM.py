...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Doorway.trafficLastDay'
        db.add_column('doorsadmin_doorway', 'trafficLastDay', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Doorway.trafficLastMonth'
        db.add_column('doorsadmin_doorway', 'trafficLastMonth', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Doorway.trafficLastYear'
        db.add_column('doorsadmin_doorway', 'trafficLastYear', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Doorway.trafficLastDay'
        db.delete_column('doorsadmin_doorway', 'trafficLastDay')

        # Deleting field 'Doorway.trafficLastMonth'
        db.delete_column('doorsadmin_doorway', 'trafficLastMonth')

        # Deleting field 'Doorway.trafficLastYear'
        db.delete_column('doorsadmin_doorway', 'trafficLastYear')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 1, 8)', 'null': 'True', 'blank': 'True'}),
