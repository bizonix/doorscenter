...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Doorway.spamLinksCount'
        db.add_column('doorsadmin_doorway', 'spamLinksCount', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Deleting field 'Net.minMaxSpamLinksCount'
        db.delete_column('doorsadmin_net', 'minMaxSpamLinksCount')

        # Deleting field 'Net.maxSpamLinksPercent'
        db.delete_column('doorsadmin_net', 'maxSpamLinksPercent')

        # Deleting field 'Net.minSpamLinksPercent'
        db.delete_column('doorsadmin_net', 'minSpamLinksPercent')

        # Deleting field 'Net.maxMaxSpamLinksCount'
        db.delete_column('doorsadmin_net', 'maxMaxSpamLinksCount')

        # Deleting field 'NetPlan.minMaxSpamLinksCount'
        db.delete_column('doorsadmin_netplan', 'minMaxSpamLinksCount')

        # Deleting field 'NetPlan.maxSpamLinksPercent'
        db.delete_column('doorsadmin_netplan', 'maxSpamLinksPercent')

        # Deleting field 'NetPlan.minSpamLinksPercent'
        db.delete_column('doorsadmin_netplan', 'minSpamLinksPercent')

        # Deleting field 'NetPlan.maxMaxSpamLinksCount'
        db.delete_column('doorsadmin_netplan', 'maxMaxSpamLinksCount')


    def backwards(self, orm):
        
        # Deleting field 'Doorway.spamLinksCount'
        db.delete_column('doorsadmin_doorway', 'spamLinksCount')

        # Adding field 'Net.minMaxSpamLinksCount'
        db.add_column('doorsadmin_net', 'minMaxSpamLinksCount', self.gf('django.db.models.fields.IntegerField')(default=10, null=True), keep_default=False)

        # Adding field 'Net.maxSpamLinksPercent'
        db.add_column('doorsadmin_net', 'maxSpamLinksPercent', self.gf('django.db.models.fields.FloatField')(default=5), keep_default=False)

        # Adding field 'Net.minSpamLinksPercent'
        db.add_column('doorsadmin_net', 'minSpamLinksPercent', self.gf('django.db.models.fields.FloatField')(default=4), keep_default=False)

        # Adding field 'Net.maxMaxSpamLinksCount'
        db.add_column('doorsadmin_net', 'maxMaxSpamLinksCount', self.gf('django.db.models.fields.IntegerField')(default=15, null=True), keep_default=False)

        # Adding field 'NetPlan.minMaxSpamLinksCount'
        db.add_column('doorsadmin_netplan', 'minMaxSpamLinksCount', self.gf('django.db.models.fields.IntegerField')(default=10, null=True), keep_default=False)

        # Adding field 'NetPlan.maxSpamLinksPercent'
        db.add_column('doorsadmin_netplan', 'maxSpamLinksPercent', self.gf('django.db.models.fields.FloatField')(default=5), keep_default=False)

        # Adding field 'NetPlan.minSpamLinksPercent'
        db.add_column('doorsadmin_netplan', 'minSpamLinksPercent', self.gf('django.db.models.fields.FloatField')(default=4), keep_default=False)

        # Adding field 'NetPlan.maxMaxSpamLinksCount'
        db.add_column('doorsadmin_netplan', 'maxMaxSpamLinksCount', self.gf('django.db.models.fields.IntegerField')(default=15, null=True), keep_default=False)
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 12, 13)', 'null': 'True', 'blank': 'True'}),
