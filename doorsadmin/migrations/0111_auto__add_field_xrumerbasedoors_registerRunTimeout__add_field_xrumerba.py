...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XrumerBaseDoors.registerRunTimeout'
        db.add_column('doorsadmin_xrumerbasedoors', 'registerRunTimeout', self.gf('django.db.models.fields.IntegerField')(default=24, null=True, blank=True), keep_default=False)

        # Adding field 'XrumerBaseSpam.registerRunTimeout'
        db.add_column('doorsadmin_xrumerbasespam', 'registerRunTimeout', self.gf('django.db.models.fields.IntegerField')(default=24, null=True, blank=True), keep_default=False)

        # Adding field 'XrumerBaseProfiles.registerRunTimeout'
        db.add_column('doorsadmin_xrumerbaseprofiles', 'registerRunTimeout', self.gf('django.db.models.fields.IntegerField')(default=24, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XrumerBaseDoors.registerRunTimeout'
        db.delete_column('doorsadmin_xrumerbasedoors', 'registerRunTimeout')

        # Deleting field 'XrumerBaseSpam.registerRunTimeout'
        db.delete_column('doorsadmin_xrumerbasespam', 'registerRunTimeout')

        # Deleting field 'XrumerBaseProfiles.registerRunTimeout'
        db.delete_column('doorsadmin_xrumerbaseprofiles', 'registerRunTimeout')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 10, 16)', 'null': 'True', 'blank': 'True'}),
        ...
        'doorsadmin.xrumerbasedoors': {
            ...
            'registerRunTimeout': ('django.db.models.fields.IntegerField', [], {'default': '24', 'null': 'True', 'blank': 'True'}),
            'registeredAccountsCount': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'runTime': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
