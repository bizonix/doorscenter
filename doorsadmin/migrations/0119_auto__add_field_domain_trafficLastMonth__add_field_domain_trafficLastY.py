...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Domain.trafficLastMonth'
        db.add_column('doorsadmin_domain', 'trafficLastMonth', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Domain.trafficLastYear'
        db.add_column('doorsadmin_domain', 'trafficLastYear', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Domain.trafficLastDate'
        db.add_column('doorsadmin_domain', 'trafficLastDate', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Domain.trafficLastMonth'
        db.delete_column('doorsadmin_domain', 'trafficLastMonth')

        # Deleting field 'Domain.trafficLastYear'
        db.delete_column('doorsadmin_domain', 'trafficLastYear')

        # Deleting field 'Domain.trafficLastDate'
        db.delete_column('doorsadmin_domain', 'trafficLastDate')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 11, 19)', 'null': 'True', 'blank': 'True'}),
            ...
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'stateSimple': ('django.db.models.fields.CharField', [], {'default': "'new'", 'max_length': '50'}),
            'trafficLastDate': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
