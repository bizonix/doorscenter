...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Doorway.makeSpam'
        db.add_column('doorsadmin_doorway', 'makeSpam', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Doorway.makeSpam'
        db.delete_column('doorsadmin_doorway', 'makeSpam')
