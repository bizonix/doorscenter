...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Doorway.runTime'
        db.add_column('doorsadmin_doorway', 'runTime', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'SnippetsSet.runTime'
        db.add_column('doorsadmin_snippetsset', 'runTime', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'SpamTask.runTime'
        db.add_column('doorsadmin_spamtask', 'runTime', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Doorway.runTime'
        db.delete_column('doorsadmin_doorway', 'runTime')

        # Deleting field 'SnippetsSet.runTime'
        db.delete_column('doorsadmin_snippetsset', 'runTime')

        # Deleting field 'SpamTask.runTime'
        db.delete_column('doorsadmin_spamtask', 'runTime')
