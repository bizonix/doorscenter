...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'XrumerBaseProfiles'
        db.delete_table('doorsadmin_xrumerbaseprofiles')

        # Adding model 'SpamProfileTask'
        db.create_table('doorsadmin_spamprofiletask', (
            ...
            ('priority', self.gf('django.db.models.fields.CharField')(default='std', max_length=20)),
            ('agent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Agent'], null=True, blank=True)),
            ('runTime', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('stateManaged', self.gf('django.db.models.fields.CharField')(default='new', max_length=50)),
            ('successCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('halfSuccessCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('failsCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('profilesCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('registeredAccountsCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('xrumerBaseRaw', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.XrumerBaseRaw'], null=True)),
            ('homePage', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True)),
            ('signature', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True)),
        ))
        db.send_create_signal('doorsadmin', ['SpamProfileTask'])


    def backwards(self, orm):
        
        # Adding model 'XrumerBaseProfiles'
        db.create_table('doorsadmin_xrumerbaseprofiles', (
            ('niche', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Niche'], null=True)),
            ('dateAdded', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('creationType', self.gf('django.db.models.fields.CharField')(default='post', max_length=50)),
            ('registerRunDate', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('successCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('signature', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True)),
            ('agent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Agent'], null=True, blank=True)),
            ('remarks', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            ('emailAddress', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('stateManaged', self.gf('django.db.models.fields.CharField')(default='new', max_length=50)),
            ...
            ('realName', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('runTime', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('registerRun', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('linksCount', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('registeredAccountsCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('priority', self.gf('django.db.models.fields.CharField')(default='std', max_length=20)),
            ('halfSuccessCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('failsCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('registerRunTimeout', self.gf('django.db.models.fields.IntegerField')(default=48, null=True, blank=True)),
            ('dateLastParsed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('baseNumber', self.gf('django.db.models.fields.IntegerField')(default=278, unique=True)),
            ('lastError', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('nickName', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('snippetsSet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.SnippetsSet'], null=True, blank=True)),
            ('profilesCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('doorsadmin', ['XrumerBaseProfiles'])

        # Deleting model 'SpamProfileTask'
        db.delete_table('doorsadmin_spamprofiletask')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateBan': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 4, 18)', 'null': 'True', 'blank': 'True'}),
            'dateRegistered': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'drop': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'maxDoorsCount': ('django.db.models.fields.IntegerField', [], {'default': '4', 'blank': 'True'}),
        ...
        'doorsadmin.net': {
            ...
            'lastError': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'makeSpam': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'maxDoorsCount': ('django.db.models.fields.IntegerField', [], {'default': '5', 'null': 'True'}),
            'maxPagesCount': ('django.db.models.fields.IntegerField', [], {'default': '900', 'null': 'True'}),
            'minDoorsCount': ('django.db.models.fields.IntegerField', [], {'default': '3', 'null': 'True'}),
        ...
        'doorsadmin.spamprofiletask': {
            'Meta': {'object_name': 'SpamProfileTask'},
            'agent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doorsadmin.Agent']", 'null': 'True', 'blank': 'True'}),
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            ...
            'homePage': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastError': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'priority': ('django.db.models.fields.CharField', [], {'default': "'std'", 'max_length': '20'}),
            ...
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'runTime': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'signature': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250', 'blank': 'True'}),
            'stateManaged': ('django.db.models.fields.CharField', [], {'default': "'new'", 'max_length': '50'}),
            'stateSimple': ('django.db.models.fields.CharField', [], {'default': "'new'", 'max_length': '50'}),
