...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Niche.language'
        db.add_column('doorsadmin_niche', 'language', self.gf('django.db.models.fields.CharField')(default='ru', max_length=50), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Niche.language'
        db.delete_column('doorsadmin_niche', 'language')
