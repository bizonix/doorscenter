...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XrumerBaseSpam.dateLastParsed'
        db.add_column('doorsadmin_xrumerbasespam', 'dateLastParsed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'XrumerBaseDoors.dateLastParsed'
        db.add_column('doorsadmin_xrumerbasedoors', 'dateLastParsed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'XrumerBaseProfiles.dateLastParsed'
        db.add_column('doorsadmin_xrumerbaseprofiles', 'dateLastParsed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'XrumerBaseRaw.dateLastParsed'
        db.add_column('doorsadmin_xrumerbaseraw', 'dateLastParsed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XrumerBaseSpam.dateLastParsed'
        db.delete_column('doorsadmin_xrumerbasespam', 'dateLastParsed')

        # Deleting field 'XrumerBaseDoors.dateLastParsed'
        db.delete_column('doorsadmin_xrumerbasedoors', 'dateLastParsed')

        # Deleting field 'XrumerBaseProfiles.dateLastParsed'
        db.delete_column('doorsadmin_xrumerbaseprofiles', 'dateLastParsed')

        # Deleting field 'XrumerBaseRaw.dateLastParsed'
        db.delete_column('doorsadmin_xrumerbaseraw', 'dateLastParsed')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2013, 2, 18)', 'null': 'True', 'blank': 'True'}),
        ...
        'doorsadmin.doorway': {
            ...
            'redirectDelay': ('django.db.models.fields.IntegerField', [], {'default': '7', 'blank': 'True'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
