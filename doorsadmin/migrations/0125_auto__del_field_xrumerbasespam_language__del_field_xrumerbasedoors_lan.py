...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'XrumerBaseSpam.language'
        db.delete_column('doorsadmin_xrumerbasespam', 'language')

        # Deleting field 'XrumerBaseDoors.language'
        db.delete_column('doorsadmin_xrumerbasedoors', 'language')

        # Deleting field 'XrumerBaseProfiles.language'
        db.delete_column('doorsadmin_xrumerbaseprofiles', 'language')

        # Deleting field 'XrumerBaseRaw.language'
        db.delete_column('doorsadmin_xrumerbaseraw', 'language')


    def backwards(self, orm):
        
        # Adding field 'XrumerBaseSpam.language'
        db.add_column('doorsadmin_xrumerbasespam', 'language', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'XrumerBaseDoors.language'
        db.add_column('doorsadmin_xrumerbasedoors', 'language', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'XrumerBaseProfiles.language'
        db.add_column('doorsadmin_xrumerbaseprofiles', 'language', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'XrumerBaseRaw.language'
        db.add_column('doorsadmin_xrumerbaseraw', 'language', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)
