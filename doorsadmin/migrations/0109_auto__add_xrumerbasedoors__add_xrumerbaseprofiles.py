...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'XrumerBaseDoors'
        db.create_table('doorsadmin_xrumerbasedoors', (
            ...
            ('baseNumber', self.gf('django.db.models.fields.IntegerField')(default=160, unique=True)),
            ...
            ('nickName', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('realName', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('password', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
            ('emailAddress', self.gf('django.db.models.fields.CharField')(default='niiokr2012@gmail.com', max_length=200)),
            ('emailLogin', self.gf('django.db.models.fields.CharField')(default='niiokr2012@gmail.com', max_length=200)),
            ('emailPassword', self.gf('django.db.models.fields.CharField')(default='kernel32', max_length=200)),
            ('emailPopServer', self.gf('django.db.models.fields.CharField')(default='pop.gmail.com', max_length=200)),
            ('creationType', self.gf('django.db.models.fields.CharField')(default='post', max_length=50)),
            ('registerRun', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.send_create_signal('doorsadmin', ['XrumerBaseDoors'])
        ...
        db.create_table('doorsadmin_xrumerbaseprofiles', (
            ...
            ('registerRun', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('registerRunDate', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('homePage', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('signature', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'XrumerBaseDoors'
        db.delete_table('doorsadmin_xrumerbasedoors')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 10, 12)', 'null': 'True', 'blank': 'True'}),
        ...
        'doorsadmin.trackers': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastError': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'piwikUrl': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            'stateSimple': ('django.db.models.fields.CharField', [], {'default': "'new'", 'max_length': '50'}),
        ...
        'doorsadmin.xrumerbasedoors': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'agent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doorsadmin.Agent']", 'null': 'True', 'blank': 'True'}),
            'baseNumber': ('django.db.models.fields.IntegerField', [], {'default': '160', 'unique': 'True'}),
            ...
            'registerRun': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
