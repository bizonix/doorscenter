...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('doorsadmin_doorwayschedule', (
            ...
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Template'], null=True, blank=True)),
            ('doorsPerDay', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ...
        # Changing field 'Doorway.doorwayTask'
        db.alter_column('doorsadmin_doorway', 'doorwayTask_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.DoorwaySchedule'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Doorway.doorwayTask'
        db.alter_column('doorsadmin_doorway', 'doorwayTask_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.DoorwayTask'], null=True))
