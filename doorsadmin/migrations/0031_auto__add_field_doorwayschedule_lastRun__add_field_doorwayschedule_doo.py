...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DoorwaySchedule.lastRun'
        db.add_column('doorsadmin_doorwayschedule', 'lastRun', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'DoorwaySchedule.doorsThisDay'
        db.add_column('doorsadmin_doorwayschedule', 'doorsThisDay', self.gf('django.db.models.fields.IntegerField')(default=0, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DoorwaySchedule.lastRun'
        db.delete_column('doorsadmin_doorwayschedule', 'lastRun')

        # Deleting field 'DoorwaySchedule.doorsThisDay'
        db.delete_column('doorsadmin_doorwayschedule', 'doorsThisDay')
