...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Domain.maxlinkedDomains'
        db.delete_column('doorsadmin_domain', 'maxlinkedDomains')

        # Adding field 'Domain.maxLinkedDomains'
        db.add_column('doorsadmin_domain', 'maxLinkedDomains', self.gf('django.db.models.fields.IntegerField')(default=5, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Domain.maxlinkedDomains'
        db.add_column('doorsadmin_domain', 'maxlinkedDomains', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'maxLinkedDomains': ('django.db.models.fields.IntegerField', [], {'default': '5', 'blank': 'True'}),
