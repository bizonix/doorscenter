...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Net.niche'
        db.add_column('doorsadmin_net', 'niche', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Niche'], null=True), keep_default=False)

        # Adding field 'Net.template'
        db.add_column('doorsadmin_net', 'template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.Template'], null=True, blank=True), keep_default=False)

        # Adding field 'Net.keywordsSet'
        db.add_column('doorsadmin_net', 'keywordsSet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doorsadmin.KeywordsSet'], null=True, blank=True), keep_default=False)
        ...
        # Adding field 'Net.minPagesCount'
        db.add_column('doorsadmin_net', 'minPagesCount', self.gf('django.db.models.fields.IntegerField')(default=500, null=True), keep_default=False)

        # Adding field 'Net.maxPagesCount'
        db.add_column('doorsadmin_net', 'maxPagesCount', self.gf('django.db.models.fields.IntegerField')(default=900, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Net.niche'
        db.delete_column('doorsadmin_net', 'niche_id')

        # Deleting field 'Net.template'
        db.delete_column('doorsadmin_net', 'template_id')

        # Deleting field 'Net.keywordsSet'
        db.delete_column('doorsadmin_net', 'keywordsSet_id')

        # Deleting field 'Net.doorgenProfile'
        db.delete_column('doorsadmin_net', 'doorgenProfile_id')

        # Deleting field 'Net.minPagesCount'
        db.delete_column('doorsadmin_net', 'minPagesCount')

        # Deleting field 'Net.maxPagesCount'
        db.delete_column('doorsadmin_net', 'maxPagesCount')
