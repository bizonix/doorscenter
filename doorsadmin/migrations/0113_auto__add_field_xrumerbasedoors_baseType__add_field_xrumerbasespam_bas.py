...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'XrumerBaseDoors.baseType'
        db.add_column('doorsadmin_xrumerbasedoors', 'baseType', self.gf('django.db.models.fields.CharField')(default='LinksList', max_length=50), keep_default=False)

        # Adding field 'XrumerBaseSpam.baseType'
        db.add_column('doorsadmin_xrumerbasespam', 'baseType', self.gf('django.db.models.fields.CharField')(default='LinksList', max_length=50), keep_default=False)

        # Adding field 'XrumerBaseProfiles.baseType'
        db.add_column('doorsadmin_xrumerbaseprofiles', 'baseType', self.gf('django.db.models.fields.CharField')(default='LinksList', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'XrumerBaseDoors.baseType'
        db.delete_column('doorsadmin_xrumerbasedoors', 'baseType')

        # Deleting field 'XrumerBaseSpam.baseType'
        db.delete_column('doorsadmin_xrumerbasespam', 'baseType')

        # Deleting field 'XrumerBaseProfiles.baseType'
        db.delete_column('doorsadmin_xrumerbaseprofiles', 'baseType')
    ...
    models = {
        ...
        'doorsadmin.domain': {
            ...
            'dateAdded': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateChanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'dateExpires': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 11, 4)', 'null': 'True', 'blank': 'True'}),
        ...
        'doorsadmin.xrumerbasedoors': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'agent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['doorsadmin.Agent']", 'null': 'True', 'blank': 'True'}),
            'baseNumber': ('django.db.models.fields.IntegerField', [], {'default': '259', 'unique': 'True'}),
            'baseType': ('django.db.models.fields.CharField', [], {'default': "'LinksList'", 'max_length': '50'}),
