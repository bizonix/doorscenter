...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Host.traffic'
        db.add_column('doorsadmin_host', 'traffic', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'DoorwaySchedule.dateStart'
        db.alter_column('doorsadmin_doorwayschedule', 'dateStart', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'Host.traffic'
        db.delete_column('doorsadmin_host', 'traffic')

        # Changing field 'DoorwaySchedule.dateStart'
        db.alter_column('doorsadmin_doorwayschedule', 'dateStart', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))
