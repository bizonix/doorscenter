...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Agent.active'
        db.add_column('doorsadmin_agent', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Agent.active'
        db.delete_column('doorsadmin_agent', 'active')
