...
5. Очистка лога событий от старых записей.

h2. Предупреждения в фиде

1. Агенты, у которых давно нет активности. Агент переводится в статус 'error'.
2. Наборы сниппетов, число которых <= 1000.
3. Выполненные задания на спам, доля успешных постов в которых <= 30%.

h2. Предупреждения в скроллерах

Ниши, у которых:
# активных доменов <= 3
# активных наборов кейвордов <= 0
# активных шаблонов <= 0
# активных наборов сниппетов <= 0
# активных готовых баз р <= 0
