...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Article.niche'
        db.delete_column('sapeadmin_article', 'niche_id')

        # Adding unique constraint on 'Donor', fields ['url']
        db.create_unique('sapeadmin_donor', ['url'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Donor', fields ['url']
        db.delete_unique('sapeadmin_donor', ['url'])
        ...
        # Adding field 'Article.niche'
        db.add_column('sapeadmin_article', 'niche', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sapeadmin.Niche'], null=True), keep_default=False)
    ...
    models = {
        ...
        'sapeadmin.sapeaccount': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'maxSitesCount': ('django.db.models.fields.IntegerField', [], {'default': '71'}),
            'password': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'})
        },
        'sapeadmin.site': {
            ...
            'niche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sapeadmin.Niche']", 'null': 'True'}),
            'pagesCount': ('django.db.models.fields.IntegerField', [], {'default': '217', 'blank': 'True'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
