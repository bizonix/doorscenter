...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.niche'
        db.alter_column('sapeadmin_article', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sapeadmin.Niche'], null=True))

        # Changing field 'Article.donor'
        db.alter_column('sapeadmin_article', 'donor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sapeadmin.Donor'], null=True))

        # Changing field 'Donor.niche'
        db.alter_column('sapeadmin_donor', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sapeadmin.Niche'], null=True))

        # Changing field 'Site.niche'
        db.alter_column('sapeadmin_site', 'niche_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sapeadmin.Niche'], null=True))

        # Changing field 'HostingAccount.hosting'
        db.alter_column('sapeadmin_hostingaccount', 'hosting_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sapeadmin.Hosting'], null=True))

        # Changing field 'WMR.WMID'
        db.alter_column('sapeadmin_wmr', 'WMID_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sapeadmin.WMID'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Article.niche'
        raise RuntimeError("Cannot reverse this migration. 'Article.niche' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Article.donor'
        raise RuntimeError("Cannot reverse this migration. 'Article.donor' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Donor.niche'
        raise RuntimeError("Cannot reverse this migration. 'Donor.niche' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Site.niche'
        raise RuntimeError("Cannot reverse this migration. 'Site.niche' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'HostingAccount.hosting'
        raise RuntimeError("Cannot reverse this migration. 'HostingAccount.hosting' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'WMR.WMID'
        raise RuntimeError("Cannot reverse this migration. 'WMR.WMID' and its values cannot be restored.")
    ...
    models = {
        ...
        'sapeadmin.sapeaccount': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'maxSitesCount': ('django.db.models.fields.IntegerField', [], {'default': '89'}),
            'password': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
        ...
        'sapeadmin.site': {
            ...
            'niche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sapeadmin.Niche']", 'null': 'True'}),
            'pagesCount': ('django.db.models.fields.IntegerField', [], {'default': '275', 'blank': 'True'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
