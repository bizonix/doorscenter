...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'HostingAccount.paymentDay'
        db.delete_column('sapeadmin_hostingaccount', 'paymentDay')

        # Adding field 'HostingAccount.paidTill'
        db.add_column('sapeadmin_hostingaccount', 'paidTill', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'HostingAccount.paymentDay'
        db.add_column('sapeadmin_hostingaccount', 'paymentDay', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'HostingAccount.paidTill'
        db.delete_column('sapeadmin_hostingaccount', 'paidTill')
    ...
    models = {
        ...
        'sapeadmin.sapeaccount': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'maxSitesCount': ('django.db.models.fields.IntegerField', [], {'default': '84'}),
            'password': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
