...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'YandexUpdate'
        db.create_table('sapeadmin_yandexupdate', (
        ...
        db.send_create_signal('sapeadmin', ['YandexUpdate'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'YandexUpdate'
        db.delete_table('sapeadmin_yandexupdate')
    ...
    models = {
        ...
        'sapeadmin.sapeaccount': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'maxSitesCount': ('django.db.models.fields.IntegerField', [], {'default': '74'}),
            'password': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'})
        },
        'sapeadmin.site': {
