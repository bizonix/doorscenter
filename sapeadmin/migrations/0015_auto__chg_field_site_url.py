...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sapeadmin_site', 'url', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))


    def backwards(self, orm):
        
        # Changing field 'Site.url'
        db.alter_column('sapeadmin_site', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, unique=True))
    ...
    models = {
        ...
        'sapeadmin.sapeaccount': {
            ...
            'maxSitesCount': ('django.db.models.fields.IntegerField', [], {'default': '98'}),
            'password': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'})
        },
        'sapeadmin.site': {
            ...
            'niche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sapeadmin.Niche']", 'null': 'True'}),
            'pagesCount': ('django.db.models.fields.IntegerField', [], {'default': '237', 'blank': 'True'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
