...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Article.textFile'
        db.delete_column('sapeadmin_article', 'textFile')

        # Adding field 'Article.fileName'
        db.add_column('sapeadmin_article', 'fileName', self.gf('django.db.models.fields.CharField')(default='', max_length=500), keep_default=False)

        # Adding field 'Article.fileDigest'
        db.add_column('sapeadmin_article', 'fileDigest', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Article.textFile'
        db.add_column('sapeadmin_article', 'textFile', self.gf('django.db.models.fields.CharField')(default='', max_length=500), keep_default=False)

        # Deleting field 'Article.fileName'
        db.delete_column('sapeadmin_article', 'fileName')

        # Deleting field 'Article.fileDigest'
        db.delete_column('sapeadmin_article', 'fileDigest')
    ...
    models = {
        ...
        'sapeadmin.site': {
            ...
            'niche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sapeadmin.Niche']", 'null': 'True'}),
            'pagesCount': ('django.db.models.fields.IntegerField', [], {'default': '204', 'blank': 'True'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
