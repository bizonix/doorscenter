...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Site.indexCountDate'
        db.delete_column('sapeadmin_site', 'indexCountDate')

        # Deleting field 'Site.indexCount'
        db.delete_column('sapeadmin_site', 'indexCount')


    def backwards(self, orm):
        
        # Adding field 'Site.indexCountDate'
        db.add_column('sapeadmin_site', 'indexCountDate', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Site.indexCount'
        db.add_column('sapeadmin_site', 'indexCount', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'sapeadmin.site': {
            ...
            'niche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sapeadmin.Niche']", 'null': 'True'}),
            'pagesCount': ('django.db.models.fields.IntegerField', [], {'default': '211', 'blank': 'True'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
            ...
            'url': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'})
        },
        'sapeadmin.spamtask': {
