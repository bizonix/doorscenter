...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'YandexUpdate', fields ['dateUpdate']
        db.delete_unique('sapeadmin_yandexupdate', ['dateUpdate'])

        # Adding unique constraint on 'YandexUpdate', fields ['dateIndex']
        db.create_unique('sapeadmin_yandexupdate', ['dateIndex'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'YandexUpdate', fields ['dateIndex']
        db.delete_unique('sapeadmin_yandexupdate', ['dateIndex'])

        # Adding unique constraint on 'YandexUpdate', fields ['dateUpdate']
        db.create_unique('sapeadmin_yandexupdate', ['dateUpdate'])
    ...
    models = {
        ...
        'sapeadmin.sapeaccount': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'maxSitesCount': ('django.db.models.fields.IntegerField', [], {'default': '91'}),
            'password': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
        ...
        'sapeadmin.site': {
            ...
            'niche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sapeadmin.Niche']", 'null': 'True'}),
            'pagesCount': ('django.db.models.fields.IntegerField', [], {'default': '220', 'blank': 'True'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
