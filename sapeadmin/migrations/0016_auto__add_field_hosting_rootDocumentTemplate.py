...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hosting.rootDocumentTemplate'
        db.add_column('sapeadmin_hosting', 'rootDocumentTemplate', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hosting.rootDocumentTemplate'
        db.delete_column('sapeadmin_hosting', 'rootDocumentTemplate')
    ...
    models = {
        ...
        'sapeadmin.sapeaccount': {
            ...
            'maxSitesCount': ('django.db.models.fields.IntegerField', [], {'default': '99'}),
            'password': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'})
        },
        'sapeadmin.site': {
            ...
            'niche': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sapeadmin.Niche']", 'null': 'True'}),
            'pagesCount': ('django.db.models.fields.IntegerField', [], {'default': '292', 'blank': 'True'}),
            'remarks': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
