...
<center><iframe name="top" src="include/parse.php?view=ftp&q=<? echo urlencode($_POST['q']); ?>&nn=<? echo urlencode($_POST['nn']); ?>&count=<? echo urlencode($_POST['count']); ?>&sin=<? echo urlencode($_POST['sin']); ?>&trans=<? echo urlencode($_POST['trans']); ?>&picture=<? echo urlencode($_POST['picture']); ?>&names=<? echo urlencode($_POST['names']); ?>&type=<? echo urlencode($_POST['type']); ?>&tpl=<? echo urlencode($_POST['tpl']); ?>&ftpuser=<? echo urlencode($_POST['ftpuser']); ?>&ftppass=<? echo urlencode($_POST['ftppass']); ?>&ftpserver=<? echo urlencode($_POST['ftpserver']); ?>&ftppatch=<? echo urlencode($_POST['ftppatch']); ?>" frameborder="0" width="372" height="236"></iframe></center><br>
